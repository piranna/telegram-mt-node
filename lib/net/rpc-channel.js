...
//     RpcChannel class
//
// This class provides a remote procedure call channel to `Telegram` through the
// given TCP|HTTP|WS connection. This channel in not encrypted and therefore use
// PlainMessage objects to wrap the communication. According with the MTProto
// specification, only few methods can use unencrypted message, see:
...
// The constructor require a [Http|Tcp|Ws]Connection, the connection must be
// already open.
