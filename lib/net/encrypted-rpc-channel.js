...
//
// This class provides an encrypted remote procedure call channel to `Telegram`
// through a TCP|HTTP|WS connection. This channel is encrypted and therefore use
// the EncryptedMessage objects to wrap the communication.
...
// - connection (required): the [Http|Tcp|Ws]Connection .
// - context (required):
